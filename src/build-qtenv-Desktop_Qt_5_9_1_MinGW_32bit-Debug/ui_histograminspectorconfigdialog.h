...
public:
    ...
    void setupUi(QDialog *HistogramInspectorConfigDialog)
    {
        ...
        HistogramInspectorConfigDialog->resize(323, 195);
    ...
    void retranslateUi(QDialog *HistogramInspectorConfigDialog)
    {
        ...
        styleLabel->setText(QApplication::translate("HistogramInspectorConfigDialog", "\351\243\216\346\240\274", Q_NULLPTR));
        styleComboBox->clear();
...
#endif // QT_NO_TOOLTIP
        minLabel->setText(QApplication::translate("HistogramInspectorConfigDialog", "\344\270\213\351\231\220", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        maxLabel->setText(QApplication::translate("HistogramInspectorConfigDialog", "\344\270\212\351\231\220", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ...
        rangeLabel->setText(QApplication::translate("HistogramInspectorConfigDialog", "\350\214\203\345\233\264", Q_NULLPTR));
    } // retranslateUi
