...
OsgViewer::OsgViewer(QWidget *parent): IOsgViewer(parent)
{
    ...
    toTerrainManipulatorAction = new QAction("地形", this);  // Terrain
    ...
    toOverviewManipulatorAction = new QAction("全局", this);   // Overview
    ...
    toTrackballManipulatorAction = new QAction("轨迹球", this);  // Trackball
...
#ifdef WITH_OSGEARTH
    toEarthManipulatorAction = new QAction("地球", this);   // Earth
...
{
    QMenu *menu = new QMenu("镜头操控器", this);
