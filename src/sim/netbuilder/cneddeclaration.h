...
class SIM_API cNedDeclaration : public NedTypeInfo
{
  ...
  protected:
    ...
    mutable StringPropsMap paramPropsMap;       // 名字到属性的映射
    mutable StringPropsMap gatePropsMap;        // 名字到GATE的映射
    mutable StringPropsMap submodulePropsMap;   // 名字到子模块映射
    mutable StringPropsMap connectionPropsMap;  // 链接
